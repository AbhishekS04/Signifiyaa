...
// --- Reusable Card --- memoized to prevent re-renders
const SocialCard = React.memo(({ children }: { children: React.ReactNode }) => (
    <TouchableOpacity
...
// --- Custom SVGs --- memoized (static content, never changes)
