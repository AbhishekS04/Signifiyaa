        ...
        <View className="px-2 mb-10 gap-6">
            ...
            <View className="bg-[#E1BEE7] rounded-[40px] p-8 pb-12">
                ...
                <View className="mb-4">
                    <Text className="text-5xl text-black leading-[0.9]">
                        <Text className="font-[ArchivoBlack_400Regular]">YOUR </Text>
                        <Text className="font-[Inter_900Black] italic">INBOX</Text>
                    </Text>
                    <Text className="text-5xl text-black leading-[0.9]">
                        <Text className="font-[ArchivoBlack_400Regular]">JUST</Text>
                    </Text>
                    <Text className="text-5xl text-black leading-[0.9] -mt-1">
                        <Text className="font-[ArchivoBlack_400Regular]">GOT </Text>
                        <Text className="font-[Inter_900Black] italic">BETTER</Text>
                    </Text>
                </View>
                ...
                <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                >
                    <Text className="text-white font-[Inter_700Bold] text-lg tracking-widest uppercase">
                        SUBSCRIBE
                    </Text>
                </TouchableOpacity>
                ...
                >
                    ...
                    <Text className="font-[Inter_500Medium] text-xs text-black shrink">
            ...
            <View className="bg-[#448AFF] rounded-[40px] p-8 pb-12">
                ...
                <View className="mb-10">
                    <Text className="text-5xl text-black leading-[0.9]">
                        <Text className="font-[ArchivoBlack_400Regular]">ALWAYS HERE</Text>
                    </Text>
                    <Text className="text-5xl text-black leading-[0.9]">
                        <Text className="font-[ArchivoBlack_400Regular]">TO </Text>
                        <Text className="font-[Inter_900Black] italic">HELP</Text>
                    </Text>
                </View>
