                            ...
                            <Animated.View entering={FadeInDown.duration(400)}>
                                ...
                                <View className="items-center mb-8">
                                    <View className="p-4 bg-white border-[3px] border-black rounded-[25px] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                                        <Image source={{ uri: `https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=upi://pay?pa=8942837703@ikwik&pn=Signifiya&am=${passType === 'day1' ? 49 : 79}` }} style={{ width: 220, height: 220, borderRadius: 10 }} />
                                    </View>
